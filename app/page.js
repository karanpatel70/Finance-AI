...
//                 <Card className="h-full border-none shadow-lg hover:shadow-xl transition-all duration-300 bg-white overflow-hidden">
//                   <CardContent className="p-8 relative">
//                     <div className="absolute top-4 right-4 text-5xl text-blue-100">"</div>
//                     <div className="flex items-center mb-6 relative z-10">
//                       <div className="relative">
//                         <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full blur-md opacity-50 animate-pulse"></div>
//                         <Image
...
//                     <div className="absolute bottom-4 right-4 text-5xl text-blue-100 rotate-180">"</div>
//                   </CardContent>
//                 </Card>
//               </motion.div>
//             ))}
...
//         {/* Animated shapes */}
//         <div className="absolute top-1/4 left-10 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-blob"></div>
//         <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
...
//                 <Button
//                   size="lg"
//                   className="bg-white text-blue-600 hover:bg-blue-50 hover:text-blue-700 font-medium px-8 py-6 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
//                 >
//                   Start Free Trial
//                   <svg
//                     xmlns="http://www.w3.org/2000/svg"
