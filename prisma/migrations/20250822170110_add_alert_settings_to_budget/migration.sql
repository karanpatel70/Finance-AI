...
CREATE TABLE "new_budgets" (
    ...
    "alertThreshold" DECIMAL NOT NULL DEFAULT 0.8,
    "alertFrequency" TEXT NOT NULL DEFAULT 'MONTHLY',
...
INSERT INTO "new_budgets" ("amount", "category", "createdAt", "id", "lastAlertSent", "rolloverAmount", "updatedAt", "userId") SELECT "amount", "category", "createdAt", "id", "lastAlertSent", "rolloverAmount", "updatedAt", "userId" FROM "budgets";
DROP TABLE "budgets";
